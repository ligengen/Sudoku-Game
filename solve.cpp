...
int Solve::times=0;
vvint Solve::result = vvint(1,vint(1,0));
Solve::Solve(vvint& tt) : vvnum(tt)
{}
int Solve::beginCrack()
{
...
int Solve::countLackNum(int i ,int j)
{
    return getLackedNumSet(i,j).size();
}
sint& Solve::getLackedNumSet(int i,int j )
{
    static sint d;
...
int Solve::attemptLocate( int i, int j )
{
